...
class SmsRepository extends CommonRepository
{
    ...
    public function getEntities(array $args = [])
    {
        $q = $this->_em
            ...
            ->from(\MauticPlugin\SimplecrmInfoBipSmsBundle\Entity\Sms::class, $this->getTableAlias(), $this->getTableAlias().'.id');
    ...
    public function getSentCount()
    {
        ...
        $q->select('SUM(e.sentCount) as sent_count')
            ->from(\MauticPlugin\SimplecrmInfoBipSmsBundle\Entity\Sms::class, 'e');
    ...
    public function getSmsList($search = '', $limit = 10, $start = 0, $viewOther = false, $smsType = null)
    {
        ...
        // CSTM: add is_published param for listing publish templates in Campaign builder - start
        $q->andWhere($q->expr()->eq('e.isPublished', true));
        // CSTM: add is_published param for listing publish templates in Campaign builder - end
